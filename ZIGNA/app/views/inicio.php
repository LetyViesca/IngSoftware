...
<header>
    <nav>
        ...
        <ul class="nav-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a href="index.php?page=m_abecedario">Abecedario</a>
                    </li>
                    <li>
                        <a href="index.php?page=m_palabras">Palabras</a>
                    </li>
                    <li>
                        <a href="index.php?page=m_frases">Frases</a>
                    </li>
                </ul>
            </li>
            <li>
                <a href="index.php?page=progreso">Progreso</a>
            </li>
        </ul>
        ...
        <div class="user-box">
            ...
            <a href="index.php?page=login" style="text-decoration:none; color:#666; font-size:14px; font-weight: 600;">
                Cerrar sesión
            </a>
