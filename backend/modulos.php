    ...
    <div class="card-grid">
        ...
        <div class="module-card">
            ...
            <div class="card-info">
                ...
                <p style="font-size:13px; color:#666;">
                    Aprende las letras para comunicarte desde lo básico.
                </p>

                <a href="M_abecedario.php" class="btn" style="background:#8a4fff">
                    ▶ Entrar al módulo
                </a>
            </div>
        </div>
        ...
        <div class="module-card">
            ...
            <div class="card-info">
                ...
                <p style="font-size:13px; color:#666;">
                    Aprende palabras comunes para el día a día.
                </p>

                <a href="M_palabras.php" class="btn" style="background:#00c2a8">
                    ▶ Entrar al módulo
                </a>
            </div>
        </div>
        ...
        <div class="module-card">
            ...
            <div class="card-info">
                ...
                <a href="M_frases.php" class="btn" style="background:#ff007a">
                    ▶ Entrar al módulo
                </a>
            </div>
        </div>
