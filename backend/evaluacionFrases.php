...
<style>
    * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', sans-serif; }
    ...
    /* 🔥 BOTÓN VOLVER (ESTILO DEGRADADO ZIGNA) */
    .btn-volver {
    ...
    .btn-volver:hover { transform: scale(1.05); opacity: 0.9; }
...
const datos = [
    { id:'p1', correcta:'Hola', img:'imag/frases/hola.png' },
    { id:'p2', correcta:'Buen día', img:'imag/frases/buen_dia.png' },
    { id:'p3', correcta:'Buenas noches', img:'imag/frases/buenas_noches.png' },
    { id:'p4', correcta:'Cuál es tu nombre', img:'imag/frases/cual_es_tu_nombre.png' },
    { id:'p5', correcta:'Tengo sed', img:'imag/frases/tengo_sed.png' },
    { id:'p6', correcta:'Gracias', img:'imag/frases/gracias.png' },
    { id:'p7', correcta:'De nada', img:'imag/frases/de_nada.png' },
    { id:'p8', correcta:'Por favor', img:'imag/frases/por_favor.png' },
    { id:'p9', correcta:'Ayuda', img:'imag/frases/ayuda.png' },
    { id:'p10', correcta:'Lo siento', img:'imag/frases/lo_siento.png' }
];

const contenedor = document.getElementById("preguntas");

// Generación de opciones dinámicas para evitar que siempre sean las mismas 4
datos.forEach((p, i) => {
...
function calificar() {
    ...
    let porcentaje = Math.round((aciertos / 10) * 100);
    localStorage.setItem("resultado_frases", porcentaje);
