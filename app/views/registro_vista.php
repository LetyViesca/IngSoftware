...
<body>
    ...
    <div class="login-card">
        ...
        <div class="login-logo-container" style="display: flex !important; justify-content: center !important; align-items: center !important; width: 100% !important; margin-bottom: 15px !important;">
            <img src="assets/img/Logo_Zigna.png" alt="ZIGNA" class="logo-login" style="height: 45px !important; width: auto !important; margin: 0 auto !important; display: block !important;">
        </div>
        ...
        <div style="margin-top:20px; font-size:13px; color:#888;">
            ¿Ya tienes cuenta? 
            <a href="index.php?page=login" style="color:#2cc19c; text-decoration:none; font-weight:bold;">
                Inicia sesión
            </a>
        </div>
    </div>
